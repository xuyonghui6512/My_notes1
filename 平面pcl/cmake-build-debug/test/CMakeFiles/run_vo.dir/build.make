...
test/CMakeFiles/run_vo.dir/run_vo.cpp.o: ../test/run_vo.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/run_vo.dir/run_vo.cpp.o"
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test && g++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/run_vo.dir/run_vo.cpp.o -c /home/xuxuxu/b/My_notes1/条形码识别/test/run_vo.cpp
...
test/CMakeFiles/run_vo.dir/run_vo.cpp.i: cmake_force
	...
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test && g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/xuxuxu/b/My_notes1/条形码识别/test/run_vo.cpp > CMakeFiles/run_vo.dir/run_vo.cpp.i
...
test/CMakeFiles/run_vo.dir/run_vo.cpp.s: cmake_force
	...
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test && g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/xuxuxu/b/My_notes1/条形码识别/test/run_vo.cpp -o CMakeFiles/run_vo.dir/run_vo.cpp.s
...
../bin/run_vo: /usr/local/lib/libopencv_aruco.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_bgsegm.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_bioinspired.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_ccalib.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_dpm.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_freetype.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_fuzzy.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_line_descriptor.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_optflow.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_reg.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_saliency.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_stereo.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_structured_light.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_phase_unwrapping.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_rgbd.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_surface_matching.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_tracking.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_datasets.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_dnn.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_face.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_plot.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_text.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_xfeatures2d.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_shape.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_video.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_ximgproc.so.3.2.0
...
../bin/run_vo: /usr/local/lib/libopencv_xobjdetect.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_objdetect.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_ml.so.3.2.0
../bin/run_vo: /usr/local/lib/libopencv_xphoto.so.3.2.0
...
../bin/run_vo: test/CMakeFiles/run_vo.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/run_vo"
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/run_vo.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/run_vo.dir/clean:
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test && $(CMAKE_COMMAND) -P CMakeFiles/run_vo.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/run_vo.dir/clean

test/CMakeFiles/run_vo.dir/depend:
	cd /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/xuxuxu/b/My_notes1/条形码识别 /home/xuxuxu/b/My_notes1/条形码识别/test /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test /home/xuxuxu/b/My_notes1/条形码识别/cmake-build-debug/test/CMakeFiles/run_vo.dir/DependInfo.cmake --color=$(COLOR)

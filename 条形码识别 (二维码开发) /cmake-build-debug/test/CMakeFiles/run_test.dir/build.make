...
test/CMakeFiles/run_test.dir/basler_video_test.cpp.o: ../test/basler_video_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/run_test.dir/basler_video_test.cpp.o"
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/run_test.dir/basler_video_test.cpp.o -c "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /test/basler_video_test.cpp"
...
test/CMakeFiles/run_test.dir/basler_video_test.cpp.i: cmake_force
	...
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /test/basler_video_test.cpp" > CMakeFiles/run_test.dir/basler_video_test.cpp.i
...
test/CMakeFiles/run_test.dir/basler_video_test.cpp.s: cmake_force
	...
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /test/basler_video_test.cpp" -o CMakeFiles/run_test.dir/basler_video_test.cpp.s
...
../bin/run_test: test/CMakeFiles/run_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/run_test"
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/run_test.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/run_test.dir/clean:
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" && $(CMAKE_COMMAND) -P CMakeFiles/run_test.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/run_test.dir/clean

test/CMakeFiles/run_test.dir/depend:
	cd "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug" && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) " "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /test" "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug" "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test" "/home/xuxuxu/b/My_notes1/条形码识别 (二维码开发) /cmake-build-debug/test/CMakeFiles/run_test.dir/DependInfo.cmake" --color=$(COLOR)

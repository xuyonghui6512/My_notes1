...
//    int FRAME_FPS = 120;
    ...
    try
    {
        ...
        info.SetSerialNumber("21638141");// left-back
...
//                temp_mat.img = Mat(IMAGE_HEIGHT,IMAGE_WIDTH,CV_8UC1,pImageBuffer);
                ...
                temp_mat.img = cv::Mat(ptrGrabResult->GetHeight(), ptrGrabResult->GetWidth(), CV_8UC3,
...
//                cout << "left_front = " << temp_mat.tag << endl;
                imshow("frame_left",temp_mat.img);
                waitKey(1);

...
//        cout<<img.cols<<"////222222222222222"<<endl;
        ...
        if(contours.size()>0&&place_rect.center.x>100&&
                place_rect.center.y>50&&place_rect.center.x<blur_img.cols-100
                &&place_rect.center.y<blur_img.rows-50) {
            int num, num1;
